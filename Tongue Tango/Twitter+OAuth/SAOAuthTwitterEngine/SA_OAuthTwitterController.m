...
- (void) loadView {
    ...
    else
    {
		...
		_navBar = [[[UINavigationBar alloc] initWithFrame: CGRectMake(0, deviceFrame.size.height-44-20, 320, 44)] autorelease];
	}
...
- (UIToolbar *) pinCopyPromptBar {
	if (_pinCopyPromptBar == nil){
		...
		_pinCopyPromptBar = [[[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, bounds.size.width, 44)] autorelease];
